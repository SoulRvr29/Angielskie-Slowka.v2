...
export const GET = async (request) => {
  try {
    ...
    console.error("Error in /api/publiczne_zestawy:", error);
    return new Response("Something went wrong", { status: 500 });
  }
};

// POST /api/publiczne_zestawy
export const POST = async (request) => {
  try {
    ...
    console.error("Error in POST /api/publiczne_zestawy:", error);
    return new Response("Something went wrong", { status: 500 });
  }
};
